...
__decorate([
    ...
    (0, common_1.Get)(),
    (0, swagger_1.ApiOperation)({ summary: 'Cari produk dengan filter & sorting (public)' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Autocomplete — saran nama produk (public)' }),
    (0, swagger_1.ApiQuery)({ name: 'q', required: true, description: 'Kata kunci minimal 1 karakter' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Array nama produk yang cocok' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Kata kunci paling sering dicari (public)' }),
    (0, swagger_1.ApiQuery)({ name: 'limit', required: false, type: Number, description: 'Default 10' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'List popular searches' }),
