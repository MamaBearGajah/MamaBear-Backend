...
async function resetAndRecreateMedia(prisma, productId, variants, images) {
...
async function seedProducts(prisma) {
    ...
    const almonMix = await prisma.product.upsert({
        where: { sku: "AL.MMBR" },
        update: { status: client_1.ProductStatus.active, stock: 700, soldCount: 312 },
        create: {
            sku: "AL.MMBR",
...
- Meningkatkan mood untuk membantu mengurangi risiko baby blues`,
    ...
    await resetAndRecreateMedia(prisma, almonMix.id, [
        ...
        { imageUrl: IMG.almon.main, publicId: "Copy_of_PDP_-_AlmonMix_01_yam9or", altText: "MamaBear AlmonMix", imageType: client_1.ImageType.main, sortOrder: 0, isFeatured: true },
        { imageUrl: IMG.almon.comparison, publicId: "Copy_of_PDP_-_AlmonMix_03_bt1huz", altText: "Perbandingan AlmonMix vs Brand Lain", imageType: client_1.ImageType.other, sortOrder: 1, isFeatured: false },
        { imageUrl: IMG.almon.nutrition, publicId: "Copy_of_PDP_-_AlmonMix_04_eh0b1z", altText: "AlmonMix Nutrition Fact", imageType: client_1.ImageType.nutrition, sortOrder: 2, isFeatured: false },
        { imageUrl: IMG.almon.ingredients, publicId: "Copy_of_PDP_-_AlmonMix_02_x6n9wr", altText: "AlmonMix Komposisi Ingredients", imageType: client_1.ImageType.ingredients, sortOrder: 3, isFeatured: false },
        { imageUrl: IMG.almon.serve, publicId: "Copy_of_PDP_-_AlmonMix_05_zwop0e", altText: "AlmonMix Cara Penyajian", imageType: client_1.ImageType.usage, sortOrder: 4, isFeatured: false },
    ]);
    const zoyaMix = await prisma.product.upsert({
        where: { sku: "ZM.MMBR" },
        update: { status: client_1.ProductStatus.active, stock: 100, soldCount: 198 },
        create: {
            sku: "ZM.MMBR",
...
*Catatan: mengandung produk turunan sapi.`,
    ...
    await resetAndRecreateMedia(prisma, zoyaMix.id, [
        ...
        { imageUrl: IMG.zoya.main, publicId: "PDP_-_ZoyaMix_01_mhnoas", altText: "MamaBear ZoyaMix", imageType: client_1.ImageType.main, sortOrder: 0, isFeatured: true },
        { imageUrl: IMG.zoya.comparison, publicId: "PDP_-_ZoyaMix_05_ev54ed", altText: "Perbandingan ZoyaMix vs Brand Lain", imageType: client_1.ImageType.other, sortOrder: 1, isFeatured: false },
        { imageUrl: IMG.zoya.nutrition, publicId: "PDP_-_ZoyaMix_06_sxz3ib", altText: "ZoyaMix Nutrition Fact", imageType: client_1.ImageType.nutrition, sortOrder: 2, isFeatured: false },
        { imageUrl: IMG.zoya.ingredients, publicId: "PDP_-_ZoyaMix_04_eik2c6", altText: "ZoyaMix Komposisi Ingredients", imageType: client_1.ImageType.ingredients, sortOrder: 3, isFeatured: false },
        { imageUrl: IMG.zoya.serve, publicId: "PDP_-_ZoyaMix_07_kgocgg", altText: "ZoyaMix Cara Penyajian", imageType: client_1.ImageType.usage, sortOrder: 4, isFeatured: false },
    ]);
    const tehPelancar = await prisma.product.upsert({
        where: { sku: "TPA.MMBR" },
        update: { status: client_1.ProductStatus.active, stock: 400, soldCount: 274 },
        create: {
            sku: "TPA.MMBR",
...
*Catatan: tidak untuk ibu hamil.`,
    ...
    await resetAndRecreateMedia(prisma, tehPelancar.id, [
        ...
        { imageUrl: IMG.teh.main, publicId: "PDP_-_Lactation_Tea_01_xwadr5", altText: "MamaBear Teh Pelancar ASI", imageType: client_1.ImageType.main, sortOrder: 0, isFeatured: true },
        { imageUrl: IMG.teh.comparison, publicId: "PDP_-_Lactation_Tea_03_mfojv8", altText: "Perbandingan Teh Pelancar ASI vs Brand Lain", imageType: client_1.ImageType.other, sortOrder: 1, isFeatured: false },
        { imageUrl: IMG.teh.ingredients, publicId: "PDP_-_Lactation_Tea_02_v0dddg", altText: "Teh Pelancar ASI Komposisi Ingredients", imageType: client_1.ImageType.ingredients, sortOrder: 2, isFeatured: false },
    ]);
    const kukis = await prisma.product.upsert({
        where: { sku: "KU.MMBR" },
        update: { status: client_1.ProductStatus.active, stock: 300, soldCount: 156 },
        create: {
            sku: "KU.MMBR",
...
*Varian Choconut BEBAS produk turunan susu sapi & TANPA TELUR`,
    ...
    await resetAndRecreateMedia(prisma, kukis.id, [
        ...
        { imageUrl: IMG.kukis.main, publicId: "Cover_Product_MamaBear_Cookie_Bites_Kukis_Almond_Oat_zlp0ht", altText: "MamaBear Kukis Almond Oat", imageType: client_1.ImageType.main, sortOrder: 0, isFeatured: true },
        { imageUrl: IMG.kukis.comparison, publicId: "PDP_-_Almond_Oat_Cookies_Cream_04_azwmin", altText: "Perbandingan Kukis Almond Oat vs Brand Lain", imageType: client_1.ImageType.other, sortOrder: 1, isFeatured: false },
        { imageUrl: IMG.kukis.ingredients, publicId: "PDP_-_Kookie_Bites_Choco_Nut_04_n0pgrd", altText: "Kukis Almond Oat Komposisi Ingredients", imageType: client_1.ImageType.ingredients, sortOrder: 2, isFeatured: false },
        { imageUrl: IMG.kukis.nutrition, publicId: "PDP_-_Kookie_Bites_Choco_Nut_02_wrcljb", altText: "Kukis Almond Oat Nutrition Fact", imageType: client_1.ImageType.nutrition, sortOrder: 3, isFeatured: false },
    ]);
    const kapsul = await prisma.product.upsert({
        where: { sku: "CP.AB30" },
        update: { status: client_1.ProductStatus.active, stock: 100, soldCount: 89 },
        create: {
            sku: "CP.AB30",
...
*Tidak untuk Ibu hamil`,
    ...
    await resetAndRecreateMedia(prisma, kapsul.id, [
        ...
        { imageUrl: IMG.kapsul.main, publicId: "MP_-_Cover_Kapsul_Bahasa_Inggris-01_ymbcky", altText: "MamaBear Kapsul ASI Booster", imageType: client_1.ImageType.main, sortOrder: 0, isFeatured: true },
        { imageUrl: IMG.kapsul.momsChoice, publicId: "MP_-_Cover_Kapsul_Bahasa_Inggris-02_ys6dsx", altText: "Alasan Ibu Memilih MamaBear Kapsul ASI Booster", imageType: client_1.ImageType.other, sortOrder: 1, isFeatured: false },
        { imageUrl: IMG.kapsul.dosage, publicId: "MP_-_Cover_Kapsul_Bahasa_Inggris-03_godphj", altText: "Dosis dan Cara Pakai Kapsul ASI Booster", imageType: client_1.ImageType.usage, sortOrder: 2, isFeatured: false },
        { imageUrl: IMG.kapsul.ingredients, publicId: "MP_-_Cover_Kapsul_Bahasa_Inggris-04_lyg3dk", altText: "Kapsul ASI Booster Komposisi", imageType: client_1.ImageType.ingredients, sortOrder: 3, isFeatured: false },
    ]);
